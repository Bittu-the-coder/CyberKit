      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex items-center gap-1 text-xs text-primary font-medium">
            Browse all courses <ArrowRight className="h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" />
          </div>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-3">
            View and manage your saved scan results, generate professional PDF reports.
          </p>
          <div className="flex items-center gap-1 text-xs text-primary font-medium">
            View my reports <ArrowRight className="h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" />
          </div>
        </Link>
      </div>
    </div>
